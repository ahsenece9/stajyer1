...
<div class="user-modal-overlay" id="assignModalOverlay">
    <div class="user-modal-card" style="max-width: 440px;">
        ...
        <div class="space-y-2" style="max-height:300px; overflow-y:auto; padding-right:4px; display:flex; flex-direction:column; gap:8px;">
            <!-- Atamayı Kaldır -->
            <div onclick="selectMentor(0)" class="flex items-center gap-3 p-2.5 rounded-xl border border-dashed border-[var(--card-border)] hover:bg-rose-50 dark:hover:bg-rose-950/20 hover:border-rose-300 dark:hover:border-rose-900 cursor-pointer transition-all" style="display:flex; align-items:center; gap:12px; padding:10px; border-radius:12px; cursor:pointer; border:1px dashed var(--card-border);">
