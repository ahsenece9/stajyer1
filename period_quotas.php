            ...
            <table id="quotasTable">
                ...
                ?>
                    <tr class="quota-row">
                        ...
                        <td style="text-align:center;"><span style="font-weight: 700; color: var(--success); font-size: 13.5px;"><?= $filled['lise'] ?> &nbsp; / &nbsp; <?= $liseQ ?></span></td>
                        <td style="text-align:center;"><span style="font-weight: 700; color: var(--primary); font-size: 13.5px;"><?= $filled['onlisans'] ?> &nbsp; / &nbsp; <?= $onlisansQ ?></span></td>
                        <td style="text-align:center;"><span style="font-weight: 700; color: var(--indigo, #6366f1); font-size: 13.5px;"><?= $filled['lisans'] ?> &nbsp; / &nbsp; <?= $lisansQ ?></span></td>
                        <td style="text-align:center;"><b style="font-size: 13.5px;"><?= $totalFilled ?> &nbsp; / &nbsp; <?= $totalQ ?></b></td>
