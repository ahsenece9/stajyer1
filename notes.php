...
<head>
    ...
    <script>
      (function() {
        ...
        var bgColors = {"dark": "#091324", "light": "#f7f9fb", "ocean": "#0f0d36", "rose": "#fff0f5"};
        document.documentElement.style.backgroundColor = bgColors[theme] || "#091324";
    ...
    <style>
        ...
        html[data-theme="light"] button.border-dashed .bg-primary-container {
...
<body class="bg-background"><canvas id="rose-bg" class="pointer-events-none" style="position:fixed; inset:0; z-index:0; display:none; background:transparent;"></canvas><canvas id="ocean-bg" class="pointer-events-none" style="position:fixed; inset:0; z-index:0; display:none; background:transparent;"></canvas><canvas id="dark-bg" class="pointer-events-none" style="position:fixed; inset:0; z-index:0; display:none; background:transparent;"></canvas><canvas id="light-bg" class="pointer-events-none" style="position:fixed; inset:0; z-index:0; display:none; background:transparent;"></canvas>
