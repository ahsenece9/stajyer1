/* Gömülü SVG ikon seti — dış font/CDN gerektirmez.
   HTML'de <span class="ms">ikon_adi</span> yazılır; bu betik
   metni ilgili SVG ile değiştirir. */
(function () {
    'use strict';
    ...
    var P = {
        ...
        motion_photos_on: '<circle cx="12" cy="12" r="9"/><circle cx="12" cy="12" r="3"/>',
    ...
    function render(root) {
        (root || document).querySelectorAll('span.ms').forEach(function (el) {
...
/* Mouse tracking for sidebar links hover effect */
